...
//   semiLight: "#5561e6",             // A very light, almost pastel blue tint
//   overLay: "rgba(0, 0, 0, 0.5)",    // Semi-transparent black for overlay effects
//   customType2: "#6367d4",           // A secondary blue shade, muted and softer
//   lite: "rgba(52, 50, 199, 0.1)",   // Transparent version of the main blue color
//   customType3: "#2A2FA9",           // A richer blue for emphasis, darker than `main`
...
// Updated primary color palette with variations of #3432c7
const primary = {
  main: "#3432c7",                  // Base blue color
  light: "#5A5CC9",                 // Lighter version of the base blue
  dark: "#1A1D8C",                  // Darker blue for contrast and depth
